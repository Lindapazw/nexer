            ...
            <CarouselContent className="-ml-6">
              <Dialog>
                ...
                <DialogContent className="max-h-full overflow-y-auto">
                  ...
                  <p>
                    ...
                    asesoramiento, ingeniería y control de calidad, acumulando
                    más de 200 GW de experiencia en proyectos de energía solar
                    fotovoltaica en todo el mundo. José Luis ejerció de CEO
                    hasta la reciente adquisición de Enertis por el grupo
                    Applus+.
                  </p>
                  <p>
                    Su actividad inversora y directiva se complementa con una
                    larga experiencia previa en Dragados (Grupo ACS), liderando
                    proyectos de infraestructuras y ocupando posiciones
                    directivas en el ámbito nacional e internacional.
                  </p>
                  <p>
                    ...
                    Renovables, destacando Nexer Solar S.L., proyecto
                    empresarial del que es co-fundador y se especializa en las
                    actividades de promoción y desarrollo de proyectos.
                  </p>
                  <p>
              ...
              <Dialog>
                ...
                <DialogContent className="max-h-full overflow-y-auto">
                  ...
                  <p>
                    ...
                    autoconsumo y PPAs para el segmento residencial y comercial
                    en México.
                  </p>
                  <p>
                    Actualmente participa en diversas empresas y vehículos de
                  ...
                  <p>
                    Manuel es Ingeniero Agrónomo por la Universidad Politécnica
                    de Madrid, Máster en Financiación de Energías Renovables por
                    el IEB (Madrid), Especialista en Mercado Eléctrico por
                    UNESA.
                  </p>
                </DialogContent>
              </Dialog>
              ...
              <Dialog>
                ...
                <DialogContent className="max-h-full overflow-y-auto">
                  ...
                  <p>
                    Laura cuenta con más de 12 años de experiencia en el sector
                    de energías renovables, enfocada principalmente en el
                    desarrollo y ejecución de proyectos de diferentes
                    tecnologías destacando su trayectoria en Villar Mir Energía
                    y en el Grupo Enertis.
                  </p>
                  <p>
                    Ha participado en la originación, diseño, valoración,
                    desarrollo y construcción de multitud de proyectos
                    greenfield y brownfield de las principales tipologías de
                    activos renovables: solar fotovoltaico, eólico e hidráulico,
                    interviniendo en más de 30 proyectos con una potencia
                    agregada superior a 1 GW.
                  </p>
                  <p>
                    Acumula un gran conocimiento técnico, regulatorio y
                    administrativo en el sector energético, habiendo
                    desarrollado con éxito varios proyectos renovables, como
                    Project Manager, en empresas como Villar Mir Energía y el
                    Grupo Enertis.
                  </p>
                  <p>
